// Connect using explicit server URL (set window.socketServerUrl in chat.html) or default to same-origin
const SOCKET_SERVER_URL = (typeof window !== 'undefined' && window.socketServerUrl) ? window.socketServerUrl : null
